...
**
** Created: Thu 6. Mar 17:47:58 2014
...
static const char qt_meta_stringdata_QApplicationRunner[] = {
    "QApplicationRunner\0\0onEvent()\0"
};

const QMetaObject QApplicationRunner::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QApplicationRunner,
      qt_meta_data_QApplicationRunner, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QApplicationRunner::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QApplicationRunner))
