...
#include "../../../../src/ARM_OD_ServerCore/Common/Router.h"
...
static const char qt_meta_stringdata_Router[] = {
    "Router\0"
};

const QMetaObject Router::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Router,
      qt_meta_data_Router, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Router::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Router))
        return static_cast<void*>(const_cast< Router*>(this));
    if (!strcmp(_clname, "IRouter"))
        return static_cast< IRouter*>(const_cast< Router*>(this));
