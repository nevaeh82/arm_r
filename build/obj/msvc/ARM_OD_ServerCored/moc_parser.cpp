...
#include "../../../../src/ARM_OD_ServerCore/AIS/parser.h"
...
static const char qt_meta_stringdata_Parser[] = {
    "Parser\0\0NewListParser(QVector<DataFly>)\0"
    "ErrorParser()\0reply\0sGetQuery(QNetworkReply*)\0"
};
...
int Parser::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: NewListParser((*reinterpret_cast< QVector<DataFly>(*)>(_a[1]))); break;
        case 1: ErrorParser(); break;
        case 2: sGetQuery((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
...
// SIGNAL 0
void Parser::NewListParser(QVector<DataFly> _t1)
{
