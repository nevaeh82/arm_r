...
#include "../../../../src/ARM_OD_viewCore/Tabs/Tree/TreeView.h"
...
static const char qt_meta_stringdata_TreeView[] = {
    "TreeView\0\0width,height\0signalResize(int,int)\0"
};
...
int TreeView::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: signalResize((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 1;
    }
...
// SIGNAL 0
void TreeView::signalResize(int _t1, int _t2)
{
