...
#include "../../../../src/ARM_OD_Common/Rpc/RpcServerBase.h"
...
static const char qt_meta_stringdata_RpcServerBase[] = {
    "RpcServerBase\0"
};

const QMetaObject RpcServerBase::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_RpcServerBase,
      qt_meta_data_RpcServerBase, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &RpcServerBase::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RpcServerBase))
