...
#include "../../../src/Qxt/qxtboundfunction.h"
...
struct qt_meta_stringdata_QxtBoundFunction_t {
    QByteArrayData data[1];
    char stringdata0[17];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QxtBoundFunction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QxtBoundFunction_t qt_meta_stringdata_QxtBoundFunction = {
    {
QT_MOC_LITERAL(0, 0, 16) // "QxtBoundFunction"
...
const QMetaObject QxtBoundFunction::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QxtBoundFunction.data,
      qt_meta_data_QxtBoundFunction,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QxtBoundFunction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QxtBoundFunction.stringdata0))
