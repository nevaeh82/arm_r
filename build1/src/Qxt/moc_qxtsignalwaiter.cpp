...
#include "../../../src/Qxt/qxtsignalwaiter.h"
...
struct qt_meta_stringdata_QxtSignalWaiter_t {
    QByteArrayData data[4];
    char stringdata0[41];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QxtSignalWaiter_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QxtSignalWaiter_t qt_meta_stringdata_QxtSignalWaiter = {
    {
QT_MOC_LITERAL(0, 0, 15), // "QxtSignalWaiter"
QT_MOC_LITERAL(1, 16, 12), // "signalCaught"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 10) // "cancelWait"

    },
    "QxtSignalWaiter\0signalCaught\0\0cancelWait"
};
...
const QMetaObject QxtSignalWaiter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QxtSignalWaiter.data,
      qt_meta_data_QxtSignalWaiter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QxtSignalWaiter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QxtSignalWaiter.stringdata0))
