...
#include "../../../src/Qxt/qxttcpconnectionmanager.h"
...
struct qt_meta_stringdata_QxtTcpConnectionManager_t {
    QByteArrayData data[1];
    char stringdata0[24];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QxtTcpConnectionManager_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QxtTcpConnectionManager_t qt_meta_stringdata_QxtTcpConnectionManager = {
    {
QT_MOC_LITERAL(0, 0, 23) // "QxtTcpConnectionManager"

    },
    "QxtTcpConnectionManager"
};
...
const QMetaObject QxtTcpConnectionManager::staticMetaObject = {
    { &QxtAbstractConnectionManager::staticMetaObject, qt_meta_stringdata_QxtTcpConnectionManager.data,
      qt_meta_data_QxtTcpConnectionManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QxtTcpConnectionManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QxtTcpConnectionManager.stringdata0))
