...
#include "../../../../../src/view/core/DB/DbManager.h"
...
QT_MOC_LITERAL(1, 10, 25), // "signalSetDataDBController"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 23) // "QMap<QString,QVariant>*"

    },
    "DbManager\0signalSetDataDBController\0"
    "\0QMap<QString,QVariant>*"
};
...
void DbManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalSetDataDBController((*reinterpret_cast< QMap<QString,QVariant>*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (DbManager::*_t)(QMap<QString,QVariant> * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DbManager::signalSetDataDBController)) {
                *result = 0;
                return;
            }
        }
