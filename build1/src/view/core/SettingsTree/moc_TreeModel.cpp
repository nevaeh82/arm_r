...
#include "../../../../../src/view/core/SettingsTree/TreeModel.h"
...
const QMetaObject TreeModel::staticMetaObject = {
    { &TreeModelBase::staticMetaObject, qt_meta_stringdata_TreeModel.data,
...
void *TreeModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "IDbChangedListener"))
        return static_cast< IDbChangedListener*>(const_cast< TreeModel*>(this));
    return TreeModelBase::qt_metacast(_clname);
}

int TreeModel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = TreeModelBase::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
