...
#include "../../../../../src/view/core/Tabs/TabManager.h"
...
QT_MOC_LITERAL(1, 11, 12), // "readyToStart"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 13), // "changeTabSlot"
QT_MOC_LITERAL(4, 39, 5), // "index"
QT_MOC_LITERAL(5, 45, 25) // "slotUpdateDBStationsLists"

    },
    "TabManager\0readyToStart\0\0changeTabSlot\0"
    "index\0slotUpdateDBStationsLists"
};
...
void TabManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->changeTabSlot((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->slotUpdateDBStationsLists(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TabManager::readyToStart)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject TabManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TabManager.data,
...
void *TabManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "IControlPanelListener"))
        return static_cast< IControlPanelListener*>(const_cast< TabManager*>(this));
