...
#include "../../../../src/view/core/Station.h"
...
const QMetaObject Station::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Station.data,
      qt_meta_data_Station,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Station::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "IStation"))
        return static_cast< IStation*>(const_cast< Station*>(this));
