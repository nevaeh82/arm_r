...
public:
	Q_MG_Style()
	{
		...
		StaticAreaFillColor2 =					QColor(255,100,0,50);
		StaticAreaFillColorAnalysis =			QColor(255,255,0,50);
		DeStaticAreaFillColor =					QColor(255,100,0,50);
		StaticAreaFillColor =					QColor(255,255,255,50);

		StaticAreaFillColorWhite =				QColor(255,255,255,100);
		DeStaticAreaFillColorWhite =			QColor(255,255,255,100);

		StaticAreaFillColorBlack =				QColor(16,16,100,100);
		DeStaticAreaFillColorBlack =			QColor(16,16,100,100);
