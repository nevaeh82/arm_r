...
public:
	...
	QColor StaticAreaFillColor2;
	QColor StaticAreaFillColorAnalysis;

	QColor StaticAreaFillColorBlack;
	QColor DeStaticAreaFillColorBlack;

	QColor StaticAreaFillColorWhite;
	QColor DeStaticAreaFillColorWhite;
