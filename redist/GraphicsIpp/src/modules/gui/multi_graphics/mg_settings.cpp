...
void Q_MG_Settings::loadSettings()
{
	...
	StaticAreaFillColor2					= settings->value("StaticAreaFillColor", StaticAreaFillColor2).value<QColor>();

	StaticAreaFillColorBlack				= settings->value("StaticAreaFillColorBlack", StaticAreaFillColorBlack).value<QColor>();
	DeStaticAreaFillColorBlack				= settings->value("DeStaticAreaFillColorBlack", DeStaticAreaFillColorBlack).value<QColor>();

	StaticAreaFillColorWhite				= settings->value("StaticAreaFillColorWhite", StaticAreaFillColorWhite).value<QColor>();
	DeStaticAreaFillColorWhite				= settings->value("DeStaticAreaFillColorWhite", DeStaticAreaFillColorWhite).value<QColor>();
