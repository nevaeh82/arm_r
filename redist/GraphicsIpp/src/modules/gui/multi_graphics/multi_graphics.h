...
public:
	...
	void			SetSelection(int mode, double,double,double,double, bool noSignal = false);//по текущему  CurSelectionType, в виртуальных бубнах
//	bool			HasSelection() const;//по всем
//	bool			HasRectSelection() const;
//	bool			HasHorSelection() const;
//	bool			HasVertSelection() const;
...
private:
	QList<typePoint> HAxisSelList;
	QMap<int, int> m_redLine;
