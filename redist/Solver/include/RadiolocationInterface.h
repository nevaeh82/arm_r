...
//характеристика качества полученной оценки: хорошое или плохое
...
struct DataFromRadioLocation {
	...
	//Вектор показателей качества полученных оценок
