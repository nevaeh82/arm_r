...
!insertmacro XPUI_DEFAULT XPUI_WELCOMEPAGE2_TEXT_TOP "Welcome to the NSIS Setup Wizard for $(^Name)."
!insertmacro XPUI_DEFAULT XPUI_WELCOMEPAGE2_TEXT "Welcome to $(^Name) Setup.  This will install $(^Name) on your computer."
!insertmacro XPUI_DEFAULT XPUI_WELCOMEPAGE2_TITLE "Welcome"
!insertmacro XPUI_DEFAULT XPUI_WELCOMEPAGE2_SUBTITLE "Welcome to $(^Name) Setup."
!insertmacro XPUI_DEFAULT XPUI_WELCOMEPAGE2_CAPTION " "

!insertmacro XPUI_DEFAULT XPUI_UNWELCOMEPAGE2_TEXT_TOP "Welcome to the NSIS Uninstall Wizard for $(^Name)."
!insertmacro XPUI_DEFAULT XPUI_UNWELCOMEPAGE2_TEXT "Welcome to $(^Name) Setup.  This will uninstall $(^Name) from your computer."
!insertmacro XPUI_DEFAULT XPUI_UNWELCOMEPAGE2_TITLE "Welcome"
!insertmacro XPUI_DEFAULT XPUI_UNWELCOMEPAGE2_SUBTITLE "Welcome to the $(^Name) Uninstaller."
...
!insertmacro XPUI_DEFAULT XPUI_UNSTARTMENUPAGE_TEXT     "Select the Start Menu folder from which to remove shortcuts:"
...
!insertmacro XPUI_DEFAULT XPUI_INSTFILESPAGE_FAIL_TITLE "Installation Incomplete"
!insertmacro XPUI_DEFAULT XPUI_INSTFILESPAGE_FAIL_SUBTITLE "$(^Name) Setup was not completed successfully."
!insertmacro XPUI_DEFAULT XPUI_UNINSTFILESPAGE_FAIL_TITLE "Uninstallation Incomplete"
!insertmacro XPUI_DEFAULT XPUI_UNINSTFILESPAGE_FAIL_SUBTITLE "$(^Name) Setup was not completed successfully."
