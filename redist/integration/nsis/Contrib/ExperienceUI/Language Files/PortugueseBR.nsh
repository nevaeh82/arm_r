...
!insertmacro XPUI_DEFAULT XPUI_WELCOMEPAGE2_TEXT_TOP "Bem-vindo ao Assistente de Instalação de $(^Name)"
!insertmacro XPUI_DEFAULT XPUI_WELCOMEPAGE2_TEXT "Bem-vindo à Instalação de $(^Name).  $(^Name) será instalado em seu computador."
!insertmacro XPUI_DEFAULT XPUI_WELCOMEPAGE2_TITLE "Bem-vindo"
!insertmacro XPUI_DEFAULT XPUI_WELCOMEPAGE2_SUBTITLE "Bem-vindo à Instalação de $(^Name)."
!insertmacro XPUI_DEFAULT XPUI_WELCOMEPAGE2_CAPTION " "

!insertmacro XPUI_DEFAULT XPUI_UNWELCOMEPAGE2_TEXT_TOP "Bem-vindo ao Assistente do NSIS de Desinstalação de $(^Name)."
!insertmacro XPUI_DEFAULT XPUI_UNWELCOMEPAGE2_TEXT "Bem-vindo à Desinstalação de $(^Name).  $(^Name) será desinstalado do seu computador."
!insertmacro XPUI_DEFAULT XPUI_UNWELCOMEPAGE2_TITLE "Bem-vindo"
!insertmacro XPUI_DEFAULT XPUI_UNWELCOMEPAGE2_SUBTITLE "Bem-vindo à Desinstalação de $(^Name)."
...
!insertmacro XPUI_DEFAULT XPUI_UNINSTFILESPAGE_DONE_SUBTITLE "A deinstalação foi concluída com sucesso."

!insertmacro XPUI_DEFAULT XPUI_INSTFILESPAGE_FAIL_TITLE "Instalação Incompleta"
!insertmacro XPUI_DEFAULT XPUI_INSTFILESPAGE_FAIL_SUBTITLE "Instalação de $(^Name) não teve êxito."
!insertmacro XPUI_DEFAULT XPUI_UNINSTFILESPAGE_FAIL_TITLE "Desinstalação Incompleta"
!insertmacro XPUI_DEFAULT XPUI_UNINSTFILESPAGE_FAIL_SUBTITLE "Desinstalação de $(^Name) não teve êxito."
