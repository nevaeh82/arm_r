;NSIS UltraModern User Interface version 1.00 beta 1
;Written by SyperPat
;based on:
...
;Portions written by Dan Fuhry
;Copyright © 2004-2005 Dan Fuhry

;Documentation: Readme.html
;License: License.txt
;Examples: Examples\UltraModernUI

!echo "NSIS Ultra Modern User Interface version 1.00 beta 1 - © 2005 SuperPat"
!echo "Based on NSIS Modern User Interface version 1.72 Written by Joost Verburg"
...
!ifndef UMUI_INCLUDED

!define UMUI_INCLUDED
...
!define UMUI_SYSVERSION "1.00 beta 1"

Var MUI_TEMP1
Var MUI_TEMP2
Var UMUI_INSTALL_ABORTED
Var UMUI_TIMESET
Var UMUI_CONFIRM_TEXT
...
!macro MUI_INTERFACE
  ...
  !ifdef MUI_UI | MUI_UI_COMPONENTSPAGE_SMALLDESC | MUI_UI_COMPONENTSPAGE_NODESC
    !warning "The MUI_UI, MUI_UI_COMPONENTSPAGE_SMALLDESC and MUI_UI_COMPONENTSPAGE_NODESC defines have been renamed in UltraModernUI in order to assure the compatibility with the former Modern UI scripts."
  !endif
  
  !insertmacro MUI_DEFAULT UMUI_UI "${NSISDIR}\Contrib\UIs\UltraModernUI\UltraModern.exe"
  !insertmacro MUI_DEFAULT UMUI_UI_COMPONENTSPAGE_SMALLDESC "${NSISDIR}\Contrib\UIs\UltraModernUI\UltraModern_smalldesc.exe"
  !insertmacro MUI_DEFAULT UMUI_UI_COMPONENTSPAGE_NODESC "${NSISDIR}\Contrib\UIs\UltraModernUI\UltraModern_nodesc.exe"
  ...
  !insertmacro MUI_DEFAULT MUI_INSTFILESPAGE_COLORS "${MUI_TEXT_COLOR} ${MUI_BGCOLOR}"
  ...
  !insertmacro MUI_DEFAULT UMUI_UNHEADERIMAGE_BMP "${UMUI_HEADERIMAGE_BMP}"
  ...
  !insertmacro MUI_DEFAULT UMUI_WELCOMEFINISHABORTPAGE_INI "${NSISDIR}\Contrib\UltraModernUI\ioSpecial.ini"
  !insertmacro MUI_DEFAULT UMUI_UNWELCOMEFINISHABORTPAGE_INI "${NSISDIR}\Contrib\UltraModernUI\ioSpecial.ini"
  !insertmacro MUI_DEFAULT UMUI_ALTERNATEWELCOMEFINISHABORTPAGE_INI "${NSISDIR}\Contrib\UltraModernUI\ioSpecial2.ini"
  !insertmacro MUI_DEFAULT UMUI_UNALTERNATEWELCOMEFINISHABORTPAGE_INI "${NSISDIR}\Contrib\UltraModernUI\ioSpecial2.ini"


  ChangeUI all "${UMUI_UI}"
  !ifdef MUI_COMPONENTSPAGE_SMALLDESC
     ChangeUI IDD_SELCOM "${UMUI_UI_COMPONENTSPAGE_SMALLDESC}"
  !else ifdef MUI_COMPONENTSPAGE_NODESC
     ChangeUI IDD_SELCOM "${UMUI_UI_COMPONENTSPAGE_NODESC}"
  !endif
...
;change la couleur de fond des différentes pages
...
!macro UMUI_PAGECOLOR_INIT ID
	FindWindow $MUI_TEMP1 "#32770" "" $HWNDPARENT
	GetDlgItem $MUI_TEMP1 $MUI_TEMP1 ${ID}
	SetCtlColors $MUI_TEMP1 ${MUI_TEXT_COLOR} ${MUI_BGCOLOR}
!macroend

!macro UMUI_PAGELIGHTCOLOR_INIT ID
	FindWindow $MUI_TEMP1 "#32770" "" $HWNDPARENT
	GetDlgItem $MUI_TEMP1 $MUI_TEMP1 ${ID}
...
!macro MUI_HEADER_TEXT TEXT SUBTEXT
  ...
  ; effaçage du texte précédent
  SetBrandingImage /IMGID=1047 "$PLUGINSDIR\Header.bmp"
...
!macro MUI_GUIINIT_BASIC UNPREFIX
	...
	SetCtlColors $MUI_TEMP1 ${MUI_TEXT_COLOR} "transparent"
	...
	SendMessage $MUI_TEMP1 ${WM_SETTEXT} 0 "STR:"
	SetCtlColors $MUI_TEMP1 0xFFFFFF ${MUI_BGCOLOR}
	...
	SendMessage $MUI_TEMP1 ${WM_SETTEXT} 0 "STR:"
	SetCtlColors $MUI_TEMP1 0xFFFFFF ${MUI_BGCOLOR}
	GetDlgItem $MUI_TEMP1 $HWNDPARENT 1307
	SendMessage $MUI_TEMP1 ${WM_SETTEXT} 0 "STR:"
	SetCtlColors $MUI_TEMP1 0xFFFFFF ${MUI_BGCOLOR}
	...
	GetDlgItem $MUI_TEMP1 $HWNDPARENT 1306
	SetCtlColors $MUI_TEMP1 "" "Transparent"
	

	ReserveFile "${UMUI_${UNPREFIX}HEADERIMAGE_BMP}"
	...
	SetOutPath "$PLUGINSDIR"
	File /oname=Header.bmp "${UMUI_${UNPREFIX}HEADERIMAGE_BMP}"
	SetBrandingImage /IMGID=1047 "$PLUGINSDIR\Header.bmp"
...
!macro MUI_WELCOMEFINISHPAGE_INIT UNINSTALLER
  ...
  !ifdef MUI_${UNINSTALLER}WELCOMEPAGE | MUI_${UNINSTALLER}FINISHPAGE | MUI_${UNINSTALLER}ABORTPAGE

	!ifdef UMUI_USE_${UNINSTALLER}ALTERNATE_PAGE
       !insertmacro MUI_INSTALLOPTIONS_EXTRACT_AS "${UMUI_${UNINSTALLER}ALTERNATEWELCOMEFINISHABORTPAGE_INI}" "ioSpecial.ini"
	!else
       !insertmacro MUI_INSTALLOPTIONS_EXTRACT_AS "${UMUI_${UNINSTALLER}WELCOMEFINISHABORTPAGE_INI}" "ioSpecial.ini"
	!endif
/*
...
!macro MUI_FUNCTION_GUIINIT
  ...
  Function .onGUIInit
	...
	!ifdef UMUI_USE_BG|UMUI_USE_CUSTOMBG
		!insertmacro UMUI_BG
	!endif

    StrCpy $UMUI_CONFIRM_TEXT ""
	StrCpy $UMUI_INSTALL_ABORTED 0
    StrCpy $UMUI_TIMESET -1
...
!macro MUI_PAGE_FINISH
  ...
  !insertmacro MUI_DEFAULT MUI_FINISHPAGE_LINK_COLOR "${UMUI_TEXT_LIGHTCOLOR}"
  !insertmacro MUI_DEFAULT UMUI_ABORTPAGE_LINK_COLOR "${MUI_FINISHPAGE_LINK_COLOR}"
...
!macro MUI_FUNCTION_WELCOMEPAGE PRE LEAVE
  ...
  Function "${PRE}"
	...
	StrCmp $UMUI_INSTALL_ABORTED 1 0 +2
	Abort

    !insertmacro MUI_WELCOMEFINISHPAGE_FUNCTION_CUSTOM


    !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Settings" "NumFields" "2"
    !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 1" "Text" "${MUI_WELCOMEPAGE_TITLE}"

	!ifndef UMUI_USE_${MUI_PAGE_UNINSTALLER_PREFIX}ALTERNATE_PAGE
	
		!ifndef MUI_WELCOMEPAGE_TITLE_3LINES
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 1" "Bottom" "55"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Top" "62"
		!else
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 1" "Bottom" "62"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Top" "69"
		!endif

	!endif

    !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Bottom" "185"
    !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Text" "${MUI_WELCOMEPAGE_TEXT}"
	...
	!ifndef UMUI_USE_${MUI_PAGE_UNINSTALLER_PREFIX}ALTERNATE_PAGE
		...
		CreateFont $MUI_TEMP2 "Tahoma" 8 350
		SendMessage $MUI_TEMP1 ${WM_SETFONT} $MUI_TEMP2 $MUI_TEMP2
		SetCtlColors $MUI_TEMP1 ${MUI_TEXT_COLOR} ${MUI_BGCOLOR}
	...
	!else
		...
		;alternate page
		GetDlgItem $MUI_TEMP1 $MUI_HWND 1200
		CreateFont $MUI_TEMP2 "MS Sans Serif" 8 700
		SendMessage $MUI_TEMP1 ${WM_SETFONT} $MUI_TEMP2 $MUI_TEMP2
		SetCtlColors $MUI_TEMP1 ${MUI_TEXT_COLOR} ${MUI_BGCOLOR}
		GetDlgItem $MUI_TEMP1 $MUI_HWND 1201
		CreateFont $MUI_TEMP2 "MS Sans Serif" 8 350
		SendMessage $MUI_TEMP1 ${WM_SETFONT} $MUI_TEMP2 $MUI_TEMP2
		SetCtlColors $MUI_TEMP1 ${MUI_TEXT_COLOR} ${MUI_BGCOLOR}
	...
	!insertmacro MUI_HEADER_TEXT_PAGE "$(UMUI_${MUI_PAGE_UNINSTALLER_PREFIX}WELCOME_TITLE)" "$(UMUI_${MUI_PAGE_UNINSTALLER_PREFIX}WELCOME_SUBTITLE)"
	LockWindow off
...
!macro MUI_FUNCTION_LICENSEPAGE PRE SHOW LEAVE
  ...
  Function "${SHOW}"
	...
	!insertmacro UMUI_PAGEBG_INIT
	!insertmacro UMUI_PAGECOLOR_INIT 1040
	!insertmacro UMUI_PAGECOLOR_INIT 1036
	!insertmacro UMUI_PAGECOLOR_INIT 1006
	!insertmacro UMUI_PAGELIGHTCOLOR_INIT 1034
	!insertmacro UMUI_PAGELIGHTCOLOR_INIT 1035
...
!macro MUI_FUNCTION_COMPONENTSPAGE PRE SHOW LEAVE
  ...
  Function "${SHOW}"
	...
	!insertmacro UMUI_PAGEBG_INIT
	!insertmacro UMUI_PAGECOLOR_INIT 1017
	!insertmacro UMUI_PAGECOLOR_INIT 1022
	!insertmacro UMUI_PAGECOLOR_INIT 1021
	!insertmacro UMUI_PAGECOLOR_INIT 1023
	!insertmacro UMUI_PAGECOLOR_INIT 1006
	!insertmacro UMUI_PAGECOLOR_INIT 1043
	!insertmacro UMUI_PAGELIGHTCOLOR_INIT 1042
...
!macro MUI_FUNCTION_DIRECTORYPAGE PRE SHOW LEAVE
  ...
  Function "${SHOW}"
	...
	!insertmacro UMUI_PAGEBG_INIT
	!insertmacro UMUI_PAGECOLOR_INIT 1001
	!insertmacro UMUI_PAGECOLOR_INIT 1008
	!insertmacro UMUI_PAGECOLOR_INIT 1006
	!insertmacro UMUI_PAGECOLOR_INIT 1023
	!insertmacro UMUI_PAGECOLOR_INIT 1024
	!insertmacro UMUI_PAGELIGHTCOLOR_INIT 1020
...
!macro MUI_FUNCTION_STARTMENUPAGE PRE LEAVE
  ...
  Function "${PRE}"
	...
	GetDlgItem $0 $MUI_TEMP1 1002
	SetCtlColors $0 ${MUI_TEXT_COLOR} ${MUI_BGCOLOR}
	GetDlgItem $0 $MUI_TEMP1 1003
	SetCtlColors $0 ${MUI_TEXT_COLOR} ${MUI_BGCOLOR}
	GetDlgItem $0 $MUI_TEMP1 1004
	SetCtlColors $0 ${MUI_TEXT_COLOR} ${MUI_BGCOLOR}
	GetDlgItem $0 $MUI_TEMP1 1005
...
!endif
  ...
  Function "${PRE}"
	...
	StrCmp $UMUI_INSTALL_ABORTED 1 0 +3
	SetAutoClose true		; else this page not abort correctly
	Abort
  ...
  Function "${SHOW}"
	...
	!insertmacro UMUI_PAGEBG_INIT
	!insertmacro UMUI_PAGECOLOR_INIT 1027
	!insertmacro UMUI_PAGECOLOR_INIT 1006
	!insertmacro UMUI_PAGECOLOR_INIT 1016
	!insertmacro UMUI_PAGELIGHTCOLOR_INIT 1004
  ...
  Function "${LEAVE}"
	...
	!ifdef UMUI_INSTFILEPAGE_ENABLE_CANCEL_BUTTON
		StrCmp $UMUI_INSTALL_ABORTED 1 0 +4
...
!macro MUI_FUNCTION_FINISHPAGE PRE LEAVE
  ...
  Function "${PRE}"
    ...
    !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 1" "Text" "${MUI_FINISHPAGE_TITLE}"
	...
	!ifndef UMUI_USE_${MUI_PAGE_UNINSTALLER_PREFIX}ALTERNATE_PAGE
		...
		!ifndef MUI_FINISHPAGE_TITLE_3LINES
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 1" "Bottom" "38"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Top" "45"
		!else
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 1" "Bottom" "48"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Top" "55"
		!endif
		
		!ifdef MUI_FINISHPAGE_RUN | MUI_FINISHPAGE_SHOWREADME
		  !ifndef MUI_FINISHPAGE_TITLE_3LINES
			!ifndef MUI_FINISHPAGE_TEXT_LARGE
			  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Bottom" "85"
			!else
			  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Bottom" "115"
			!endif
		  !else
			!ifndef MUI_FINISHPAGE_TEXT_LARGE
			  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Bottom" "95"
			!else
			  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Bottom" "125"
			!endif
		  !endif
		!else
		  !ifndef MUI_FINISHPAGE_LINK
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Bottom" "185"
		  !else
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Bottom" "175"
		  !endif
		!endif
		...
		!ifndef MUI_FINISHPAGE_NOREBOOTSUPPORT
		  ...
		  IfRebootFlag 0 mui.finish_noreboot_init
			...
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Text" "${MUI_FINISHPAGE_TEXT_REBOOT}"
	
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Settings" "Numfields" "4"
	
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Type" "RadioButton"
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Text" "${MUI_FINISHPAGE_TEXT_REBOOTNOW}"
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Left" "16"
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Right" "321"
			!ifndef MUI_FINISHPAGE_TITLE_3LINES
			  !ifndef MUI_FINISHPAGE_TEXT_LARGE
				!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Top" "90"
				!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Bottom" "100"
			  !else
				!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Top" "120"
				!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Bottom" "130"
			  !endif
			!else
			  !ifndef MUI_FINISHPAGE_TEXT_LARGE
				!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Top" "100"
				!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Bottom" "110"
			  !else
				!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Top" "130"
				!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Bottom" "140"
			  !endif
			!endif
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "State" "1"
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Type" "RadioButton"
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Text" "${MUI_FINISHPAGE_TEXT_REBOOTLATER}"
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Left" "16"
		...
		!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Text" "${MUI_FINISHPAGE_TEXT}"
	
		!ifdef MUI_FINISHPAGE_RUN
	
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Type" "CheckBox"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Text" "${MUI_FINISHPAGE_RUN_TEXT}"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Left" "16"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Right" "315"
		  !ifndef MUI_FINISHPAGE_TITLE_3LINES
			!ifndef MUI_FINISHPAGE_TEXT_LARGE
			  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Top" "90"
			  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Bottom" "100"
		...
		!ifdef MUI_FINISHPAGE_SHOWREADME
		  ...
		  !ifndef MUI_FINISHPAGE_RUN
			!define MUI_FINISHPAGE_CURFIELD_NO 3
			!ifndef MUI_FINISHPAGE_TITLE_3LINES
			  !ifndef MUI_FINISHPAGE_TEXT_LARGE
		  ...
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Left" "16"
	...
	!else
		...
		!ifdef MUI_FINISHPAGE_RUN | MUI_FINISHPAGE_SHOWREADME
			!ifndef MUI_FINISHPAGE_TEXT_LARGE
			  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Bottom" "124"
			!else
			  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Bottom" "154"
			!endif
		!else
		  !ifndef MUI_FINISHPAGE_LINK
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Bottom" "224"
		  !else
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Bottom" "214"
		  !endif
		!endif
		...
		!ifndef MUI_FINISHPAGE_NOREBOOTSUPPORT
		  ...
		  IfRebootFlag 0 mui.finish_noreboot_init
			  ...
			  !ifndef MUI_FINISHPAGE_TEXT_LARGE
				!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Bottom" "124"
			  !else
				!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Bottom" "151"
			  !endif
			...
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Type" "RadioButton"
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Text" "${MUI_FINISHPAGE_TEXT_REBOOTNOW}"
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Left" "52"
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Right" "321"

			  !ifndef MUI_FINISHPAGE_TEXT_LARGE
				!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Top" "129"
				!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Bottom" "139"
			  !else
				!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Top" "159"
				!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Bottom" "169"
			  !endif

			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "State" "1"
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Type" "RadioButton"
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Text" "${MUI_FINISHPAGE_TEXT_REBOOTLATER}"
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Left" "52"
			!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Right" "321"

			  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Top" "149"
			  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Bottom" "159"
		...
		!ifdef MUI_FINISHPAGE_SHOWREADME
		  ...
		  !ifndef MUI_FINISHPAGE_RUN
			!define MUI_FINISHPAGE_CURFIELD_NO 3
			  ...
			  !ifndef MUI_FINISHPAGE_TEXT_LARGE
				!define MUI_FINISHPAGE_CURFIELD_TOP 124
				!define MUI_FINISHPAGE_CURFIELD_BOTTOM 139
			  !else
				!define MUI_FINISHPAGE_CURFIELD_TOP 154
				!define MUI_FINISHPAGE_CURFIELD_BOTTOM 169
			  !endif
		  ...
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Type" "CheckBox"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Text" "${MUI_FINISHPAGE_SHOWREADME_TEXT}"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Left" "52"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Right" "315"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Top" "${MUI_FINISHPAGE_CURFIELD_TOP}"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Bottom" "${MUI_FINISHPAGE_CURFIELD_BOTTOM}"
		  !ifndef MUI_FINISHPAGE_SHOWREADME_NOTCHECKED
		...
		!ifdef MUI_FINISHPAGE_LINK
		  ...
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Left" "52"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Right" "315"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Top" "195"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Bottom" "205"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "State" "${MUI_FINISHPAGE_LINK_LOCATION}"
  ...
  Function "${LEAVE}"
    ...
    !ifndef MUI_FINISHPAGE_NOREBOOTSUPPORT
      ...
      IfRebootFlag "" mui.finish_noreboot_end
        ...
        !insertmacro MUI_INSTALLOPTIONS_READ $MUI_TEMP1 "ioSpecial.ini" "Field 3" "State"
...
!macro MUI_UNFUNCTION_CONFIRMPAGE PRE SHOW LEAVE
  ...
  Function "${SHOW}"
	...
	SetCtlColors $MUI_TEMP1 0x000000 ${MUI_TEXT_COLOR}
	
	!insertmacro UMUI_PAGECOLOR_INIT 1029
	!insertmacro UMUI_PAGECOLOR_INIT 1000
	!insertmacro UMUI_PAGECOLOR_INIT 1006
...
!macro UMUI_PAGE_CONFIRM
  ...
  !insertmacro MUI_SET MUI_CONFIRMPAGE
  
  !insertmacro MUI_DEFAULT UMUI_CONFIRMPAGE_TEXT_TOP "$(UMUI_INSTCONFIRM_TEXT_TOP)"
  !insertmacro MUI_DEFAULT UMUI_CONFIRMPAGE_TEXT_BOTTOM "$(UMUI_INSTCONFIRM_TEXTBOX_TITLE)"
  
  PageEx custom

    PageCallbacks mui.ConfirmPre_${MUI_UNIQUEID} mui.ConfirmLeave_${MUI_UNIQUEID}

    Caption " "

  PageExEnd

  !insertmacro UMUI_FUNCTION_CONFIRMPAGE mui.ConfirmPre_${MUI_UNIQUEID} mui.ConfirmLeave_${MUI_UNIQUEID}
...
!macro UMUI_FUNCTION_CONFIRMPAGE PRE LEAVE
  ...
  Function "${PRE}"
	...
	!insertmacro MUI_INSTALLOPTIONS_EXTRACT_AS "${NSISDIR}\Contrib\UltraModernUI\confirm.ini" "confirm.ini"
	
	!insertmacro MUI_HEADER_TEXT_PAGE "$(UMUI_INSTCONFIRM_TITLE)" "$(UMUI_INSTCONFIRM_SUBTITLE)"
	
	!insertmacro MUI_INSTALLOPTIONS_WRITE "confirm.ini" "Settings" NextButtonText "$(^NextBtn)"
	!insertmacro MUI_INSTALLOPTIONS_WRITE "confirm.ini" "Field 1" Text "${UMUI_CONFIRMPAGE_TEXT_TOP}"
	!insertmacro MUI_INSTALLOPTIONS_WRITE "confirm.ini" "Field 2" Text "${UMUI_CONFIRMPAGE_TEXT_BOTTOM}"

	!ifdef UMUI_CONFIRMPAGE_TEXTBOX
	
		!insertmacro MUI_INSTALLOPTIONS_WRITE "confirm.ini" "Settings" NumFields "3"
		
		StrCpy $UMUI_CONFIRM_TEXT ""
		Call "${UMUI_CONFIRMPAGE_TEXTBOX}"

		!insertmacro MUI_INSTALLOPTIONS_WRITE "confirm.ini" "Field 3" State "$UMUI_CONFIRM_TEXT"
...
!macro UMUI_CONFIRMPAGE_TEXTBOX_ADDLINE STR
	...
	StrCpy $UMUI_CONFIRM_TEXT "$UMUI_CONFIRM_TEXT${STR}\r\n"
...
!macro UMUI_PAGE_ABORT
  ...
  !insertmacro MUI_SET MUI_${MUI_PAGE_UNINSTALLER_PREFIX}ABORTPAGE

  !insertmacro MUI_DEFAULT UMUI_ABORTPAGE_TITLE "$(UMUI_${MUI_PAGE_UNINSTALLER_PREFIX}TEXT_ABORT_INFO_TITLE)"
  !insertmacro MUI_DEFAULT UMUI_ABORTPAGE_TEXT "$(UMUI_${MUI_PAGE_UNINSTALLER_PREFIX}TEXT_ABORT_INFO_TEXT)"
...
!macro UMUI_FUNCTION_ABORTPAGE PRE LEAVE
  ...
  Function "${PRE}"
	...
	StrCmp $UMUI_INSTALL_ABORTED 0 0 +2
	Quit

	!insertmacro MUI_HEADER_TEXT_PAGE "$(MUI_${MUI_PAGE_UNINSTALLER_PREFIX}TEXT_ABORT_TITLE)" "$(MUI_${MUI_PAGE_UNINSTALLER_PREFIX}TEXT_ABORT_SUBTITLE)"
	
	!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Settings" "NumFields" "2"
	!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini"  "Settings" NextButtonText "$(^CloseBtn)"
	!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini"  "Field 1" Text "${UMUI_ABORTPAGE_TITLE}"
	...
	!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini"  "Field 2" Text "${UMUI_ABORTPAGE_TEXT}"
	...
	!ifdef UMUI_ABORTPAGE_LINK
	  ...
	  !ifndef UMUI_USE_${MUI_PAGE_UNINSTALLER_PREFIX}ALTERNATE_PAGE
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Type" "Link"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Text" "${UMUI_ABORTPAGE_LINK}"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Left" "16"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Right" "315"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Top" "175"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Bottom" "185"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "State" "${UMUI_ABORTPAGE_LINK_LOCATION}"
	  !else
	  	  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Type" "Link"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Text" "${UMUI_ABORTPAGE_LINK}"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Left" "52"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Right" "315"
		  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Top" "195"
...
; we can't use InstallOptions::dialog because the background will not be initialised
!macro MUI_INSTALLOPTIONS_DISPLAY FILE
  ...
  !verbose ${MUI_VERBOSE}
    ...
    !insertmacro MUI_INSTALLOPTIONS_INITDIALOG "${FILE}"
    Pop $MUI_TEMP1
    SetCtlColors $MUI_TEMP1 "" "${MUI_BGCOLOR}"
...
!macro MUI_LANGUAGEFILE_END
  ...
  !include "${NSISDIR}\Contrib\UltraModernUI\Language files\Default.nsh"
  ...
  !insertmacro MUI_LANGUAGEFILE_LANGSTRING_PAGE WELCOME "UMUI_WELCOME_TITLE"
  !insertmacro MUI_LANGUAGEFILE_LANGSTRING_PAGE WELCOME "UMUI_WELCOME_SUBTITLE"

  !insertmacro MUI_LANGUAGEFILE_LANGSTRING_PAGE CONFIRM "UMUI_INSTCONFIRM_SUBTITLE"
  !insertmacro MUI_LANGUAGEFILE_LANGSTRING_PAGE CONFIRM "UMUI_INSTCONFIRM_TITLE"
  !insertmacro MUI_LANGUAGEFILE_LANGSTRING_PAGE CONFIRM "UMUI_INSTCONFIRM_TEXT_TOP"
  !insertmacro MUI_LANGUAGEFILE_LANGSTRING_PAGE CONFIRM "UMUI_INSTCONFIRM_TEXTBOX_TITLE"

  !insertmacro MUI_LANGUAGEFILE_LANGSTRING_PAGE CONFIRM "UMUI_INSTCONFIRM_TEXTBOX_DESTINATION_LOCATION"
  !insertmacro MUI_LANGUAGEFILE_LANGSTRING_PAGE CONFIRM "UMUI_INSTCONFIRM_TEXTBOX_START_MENU_FLODER"


  !insertmacro MUI_LANGUAGEFILE_LANGSTRING_PAGE ABORT "UMUI_TEXT_ABORT_INFO_TITLE"
  !insertmacro MUI_LANGUAGEFILE_LANGSTRING_PAGE ABORT "UMUI_TEXT_ABORT_INFO_TEXT"
  ...
  !insertmacro MUI_LANGUAGEFILE_UNLANGSTRING_PAGE WELCOME "UMUI_UNWELCOME_TITLE"
  !insertmacro MUI_LANGUAGEFILE_UNLANGSTRING_PAGE WELCOME "UMUI_UNWELCOME_SUBTITLE"

  !insertmacro MUI_LANGUAGEFILE_UNLANGSTRING_PAGE ABORT "UMUI_UNTEXT_ABORT_INFO_TITLE"
  !insertmacro MUI_LANGUAGEFILE_UNLANGSTRING_PAGE ABORT "UMUI_UNTEXT_ABORT_INFO_TEXT"


  !insertmacro MUI_LANGUAGEFILE_LANGSTRING_DEFINE MUI_UNABORTWARNING "MUI_UNTEXT_ABORTWARNING"


  !insertmacro MUI_LANGUAGEFILE_LANGSTRING "UMUI_LEFT_TIME_TEXT"
  !insertmacro MUI_LANGUAGEFILE_LANGSTRING "UMUI_LEFT_TIME_X_MINUTES"
  !insertmacro MUI_LANGUAGEFILE_LANGSTRING "UMUI_LEFT_TIME_ONE_MINUTE"
  !insertmacro MUI_LANGUAGEFILE_LANGSTRING "UMUI_LEFT_TIME_LESS_THAN_ONE_MINUTE"

  !insertmacro MUI_LANGUAGEFILE_LANGSTRING "UMUI_LEFTMESSAGEBOX_OK"
  !insertmacro MUI_LANGUAGEFILE_LANGSTRING "UMUI_LEFTMESSAGEBOX_YES"
  !insertmacro MUI_LANGUAGEFILE_LANGSTRING "UMUI_LEFTMESSAGEBOX_NO"
...
!macro UMUI_LEFT_SETTIME MINS

	StrCpy $UMUI_TIMESET "${MINS}"
	
	IntCmp ${MINS} 0 0 not0${MINS} not0${MINS}
	!insertmacro UMUI_LEFT_TEXTE "$(UMUI_LEFT_TIME_TEXT)" "$(UMUI_LEFT_TIME_LESS_THAN_ONE_MINUTE)"
	Goto end${MINS}
	
	not0${MINS}:
	IntCmp ${MINS} 1 0 not1${MINS} not1${MINS}
	!insertmacro UMUI_LEFT_TEXTE "$(UMUI_LEFT_TIME_TEXT)" "$(UMUI_LEFT_TIME_ONE_MINUTE)"
	Goto end${MINS}
	
	not1${MINS}:
	!insertmacro UMUI_LEFT_TEXTE "$(UMUI_LEFT_TIME_TEXT)" "${MINS} $(UMUI_LEFT_TIME_X_MINUTES)"
...
!macro UMUI_LEFT_TEXTE TEXTETOP TEXTEBTM
	BringToFront
	SetBrandingImage /IMGID=1302 "$PLUGINSDIR\LeftImg.bmp"
	GetDlgItem $MUI_TEMP1 $HWNDPARENT 1100
	CreateFont $MUI_TEMP2 Arial 8 350
	SendMessage "$MUI_TEMP1" "${WM_SETFONT}" "$MUI_TEMP2" ""
	SendMessage "$MUI_TEMP1" "${WM_SETTEXT}" 0 "STR:${TEXTETOP}"
	ShowWindow $MUI_TEMP1 ${SW_SHOW}
	GetDlgItem $MUI_TEMP1 $HWNDPARENT 1101
	CreateFont $MUI_TEMP2 Arial 8 700
	SendMessage "$MUI_TEMP1" "${WM_SETFONT}" "$MUI_TEMP2" ""
	SendMessage "$MUI_TEMP1" "${WM_SETTEXT}" 0 "STR:${TEXTEBTM}"
	ShowWindow $MUI_TEMP1 ${SW_SHOW}
!macroend



!macro UMUI_UNPAGE_LEFTMESSAGEBOX TYPE MSGTOP MSGBTM
  ...
  !insertmacro MUI_UNPAGE_INIT
    ...
    !insertmacro UMUI_PAGE_LEFTMESSAGEBOX ${TYPE} "${MSGTOP}" "${MSGBTM}"
...
!macro UMUI_PAGE_LEFTMESSAGEBOX TYPE MSGTOP MSGBTM
  ...
  PageEx ${MUI_PAGE_UNINSTALLER_FUNCPREFIX}custom
    ...
    PageCallbacks ${MUI_PAGE_UNINSTALLER_FUNCPREFIX}mui.MSBBOXPre_${MUI_UNIQUEID} ${MUI_PAGE_UNINSTALLER_FUNCPREFIX}mui.MSGBOXLeave_${MUI_UNIQUEID}

    Caption " "

  PageExEnd
  
  Function ${MUI_PAGE_UNINSTALLER_FUNCPREFIX}mui.MSBBOXPre_${MUI_UNIQUEID}
	...
	; MESSAGE TEXTS
	!insertmacro UMUI_LEFT_TEXTE "${MSGTOP}" "${MSGBTM}"
	...
	!insertmacro MUI_INSTALLOPTIONS_EXTRACT_AS "${NSISDIR}\Contrib\UltraModernUI\LeftMesgBox.ini" "LeftMesgBox.ini"
	
    !insertmacro MUI_INSTALLOPTIONS_INITDIALOG "LeftMesgBox.ini"
    Pop $1
    SetCtlColors $1 "" "${MUI_BGCOLOR}"
	...
	; BUTTON GOTOS
	StrCmp ${TYPE} 3 Type3.${MUI_UNIQUEID}
	StrCmp ${TYPE} 1 Type1.${MUI_UNIQUEID} Type2.${MUI_UNIQUEID}
	
	; OK
	Type1.${MUI_UNIQUEID}:
	GetDlgItem $MUI_TEMP1 $1 1200
	SendMessage $MUI_TEMP1 ${WM_SETTEXT} 0 "STR:$(UMUI_LEFTMESSAGEBOX_OK)"
	ShowWindow $MUI_TEMP1 ${SW_SHOW}
	GetDlgItem $MUI_TEMP1 $1 1201
	ShowWindow $MUI_TEMP1 ${SW_HIDE}
	GetDlgItem $MUI_TEMP1 $1 1202
	ShowWindow $MUI_TEMP1 ${SW_HIDE}
	Goto Done.${MUI_UNIQUEID}
	StrCmp ${TYPE} 2 "" Type3.${MUI_UNIQUEID}
	...
	ShowWindow $MUI_TEMP1 ${SW_SHOW}
	GetDlgItem $MUI_TEMP1 $1 1202
	SendMessage $MUI_TEMP1 ${WM_SETTEXT} 0 "STR:$(^CancelBtn)"
	ShowWindow $MUI_TEMP1 ${SW_SHOW}
	Goto Done.${MUI_UNIQUEID}
	...
	ShowWindow $MUI_TEMP1 ${SW_HIDE}
	GetDlgItem $MUI_TEMP1 $1 1201
	SendMessage $MUI_TEMP1 ${WM_SETTEXT} 0 "STR:$(UMUI_LEFTMESSAGEBOX_YES)"
	ShowWindow $MUI_TEMP1 ${SW_SHOW}
	GetDlgItem $MUI_TEMP1 $1 1202
	SendMessage $MUI_TEMP1 ${WM_SETTEXT} 0 "STR:$(UMUI_LEFTMESSAGEBOX_NO)"
	ShowWindow $MUI_TEMP1 ${SW_SHOW}
  ...
  Function ${MUI_PAGE_UNINSTALLER_FUNCPREFIX}mui.MSGBOXLeave_${MUI_UNIQUEID}

	!insertmacro UMUI_LEFT_TEXTE "" ""

	GetDlgItem $MUI_TEMP1 $HWNDPARENT 1306
	ShowWindow $MUI_TEMP1 ${SW_HIDE}
	
	!ifdef UMUI_LEFTMESSAGEBOX_VAR
		ReadINIStr "$${UMUI_LEFTMESSAGEBOX_VAR}" "$PLUGINSDIR\LeftMesgBox.ini" "Settings" "State"
	; type 1   OK=1
	; type 2   OK=2   Cancel=3
	; type 3   YES=2  NO=3
	!endif
	!insertmacro MUI_UNSET UMUI_LEFT_MESSAGEBOX_VAR

	!ifdef UMUI_LEFTMESSAGEBOX_LEFTFUNC
		Call "${MUI_PAGE_UNINSTALLER_FUNCPREFIX}${UMUI_LEFTMESSAGEBOX_LEFTFUNC}"
	!endif
	!insertmacro MUI_UNSET UMUI_LEFT_MESSAGEBOX_LEFTFUNC
	
	; on remet le temps si il à été définit et on éfface le texte
	StrCmp $UMUI_TIMESET "-1" notime 0
		!insertmacro UMUI_LEFT_SETTIME $UMUI_TIMESET
	notime:
  FunctionEnd
