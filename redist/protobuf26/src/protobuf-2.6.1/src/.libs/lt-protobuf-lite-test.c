...
/* ./.libs/lt-protobuf-lite-test.c - temporary wrapper executable for .libs/protobuf-lite-test.exe
   Generated by libtool (GNU libtool) 2.4

   The protobuf-lite-test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "protobuf-lite-test.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# protobuf-lite-test - temporary wrapper script for .libs/protobuf-lite-test.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4\n", f);
  fputs ("#\n", f);
  fputs ("# The protobuf-lite-test program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"protobuf-lite-test.exe:protobuf-lite-test:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"protobuf-lite-test.exe:protobuf-lite-test:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"protobuf-lite-test.exe:protobuf-lite-test:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='protobuf-lite-test.exe'\n", f);
