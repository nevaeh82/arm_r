...
/* ./.libs/lt-protoc.c - temporary wrapper executable for .libs/protoc.exe
...
const char * TARGET_PROGRAM_NAME = "protoc.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# protoc - temporary wrapper script for .libs/protoc.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4\n", f);
  fputs ("#\n", f);
  fputs ("# The protoc program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"protoc.exe:protoc:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"protoc.exe:protoc:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"protoc.exe:protoc:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
