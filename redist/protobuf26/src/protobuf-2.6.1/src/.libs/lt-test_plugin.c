...
/* ./.libs/lt-test_plugin.c - temporary wrapper executable for .libs/test_plugin.exe
   Generated by libtool (GNU libtool) 2.4

   The test_plugin program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test_plugin.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test_plugin - temporary wrapper script for .libs/test_plugin.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4\n", f);
  fputs ("#\n", f);
  fputs ("# The test_plugin program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"test_plugin.exe:test_plugin:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_plugin.exe:test_plugin:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_plugin.exe:test_plugin:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
