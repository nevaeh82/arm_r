...
DROP SCHEMA IF EXISTS `testStations` ;
CREATE SCHEMA `testStations` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `testStations` ;
...
-- -----------------------------------------------------
GRANT ALL ON `testStations`.* TO 'uavtest'@'localhost' IDENTIFIED BY 'uavtest';