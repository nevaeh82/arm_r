...
//	 _current_tab_widget  = static_cast<TabSpectrum* >(m_tabWidget->currentWidget());
...
int TabManager::createSubModules(const QString& settingsFile)
{
	...
	connect(m_tabWidget, SIGNAL(changeTabSignal(int)), this, SLOT(changeTabSlot(int)));
...
{
	///TODO: update
	//m_tabWidget->tabBar()->setCurrentIndex(id);
